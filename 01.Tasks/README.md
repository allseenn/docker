...
Как видно на картинки процесс настройки chroot с полноценным набором команд занимает гораздо меньше места нежели процесс поиска и копирования библиотек для каждой утилиты и команды linux.
